...
public class AppConfig
{
    ...
    public static readonly string APPINFO =
@"- アプリ情報 -
Ver 1.0.0 アプリ公開しました。

- 作者より -
当アプリをご利用いただきありがとうございます！問題は順次更新(増加)していく予定なのでしばらくお待ちください^^
問題の間違え、不具合などございましたらご連絡お願いしますm(_ _)m
当アプリのサーバー維持費などは広告収入から成り立っております故、最小限にしたつもりですので広告が表示されるのをご理解ください(_ _)
今後も私どものアプリをどうかよろしくお願いします！

YounashiP
作者ホームページ(https://younaship.com/)
";

    public static readonly string README = 
@"ダウンロードいただきありがとうございます。アプリをご利用の前に利用規約・プライバシーポリシーに同意する必要があります。OKを押した時点で規約に同意したとみなされます。

- 利用規約 - 2019.06

この利用規約（以下，「本規約」といいます。）は，YounashiP（以下，「当方」といいます。）が提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。ご利用のユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
